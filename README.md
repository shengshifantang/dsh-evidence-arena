...
### Verified compatibility snapshot — 2026-08-18

- The standalone repository passes both TypeScript faces, 17 test files / 79 tests, Host ESM build, browser loader build, and package-closure verification on macOS.
